...
import { ArrowDown, ArrowUp, TableWrapper, TabsContainer, TabText, ThItemContainer, Wrapper } from './styles'
import {
   ColumnDef,
   getCoreRowModel,
   getFilteredRowModel,
...
export default function Achievement() {
   ...
   return (
      <Wrapper>
         <TabsContainer>
            {
               tabText.map((item, index) => <TabText key={index} activeTab={activeTab === index ? true : false} onClick={() => handleActiveTab(index)} >
                  {item}
               </TabText>)
            }
         </TabsContainer>
