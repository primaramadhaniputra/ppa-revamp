...
import { MapContainer, useMap, SVGOverlay, useMapEvents } from "react-leaflet";
...
const position = [51.4946, -0.073];

export default function Map() {
	const [strokeSize, setStrokeSize] = useState(1.5);
	...
	return (
		<MapContainer center={position as LatLngTuple} style={{ height: "500px" }} zoom={18}>
			<SVGOverlay attributes={{ stroke: "red" }} bounds={bounds as LatLngBoundsLiteral}>
				<svg width="100%" height="100%" viewBox="-44 6 1972 480">
					<g>
						<path
							stroke="#fcfcfc"
							stroke-opacity="0.9"
