...
const UploadDar = dynamic(() => import("./UploadDar"), { ssr: false });
const UpdateRoster = dynamic(() => import("./UpdateRoster"), { ssr: false });
const SuratPerintahLembur = dynamic(() => import("./SuratPerintahLembur"), { ssr: false });
...
const EmployeeMutation = dynamic(() => import("./EmployeeMutation"), { ssr: false });
const BenefitClaimVoucher = dynamic(() => import("./BenefitClaimVoucher"), { ssr: false });
const AttendanceRevision = dynamic(() => import("./AttendanceRevision"), { ssr: false });
