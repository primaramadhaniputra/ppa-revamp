...
export default function TidakSesuaiJadwal() {
   ...
   return (
      <Wrapper>
         <Container >
            <Text variant='h4' style={{ fontWeight: fontWeights.bold, display: 'flex', alignItems: 'center', fontSize: fontSizing.xl.fontSize, color: '#4F5458' }} >Tidak sesuai jadwal</Text>
