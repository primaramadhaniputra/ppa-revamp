		...
		<Wrapper>
			...
			<Grid container flexDirection="column" gap={40}>
				<Grid container gap={20}>
					<Grid>
						<LabeledInput name="Nama" title="Nama" value={users.fullName} disabled={true} />
					</Grid>
					<Grid>
						<LabeledInput name="NRP" title="NRP" value={users.nrp} disabled={true} />
					</Grid>
				</Grid>
				<Grid container gap={20}>
					<Grid>
						<LabeledInput name="Jabatan" title="Jabatan" value={users.position} disabled={true} />
					</Grid>
					<Grid>
						<LabeledInput name="valid-mcu" title="Valid Mcu" value={users.mcu} disabled={true} />
					</Grid>
				</Grid>
			</Grid>
		</Wrapper>
