			...
			<form onSubmit={handleSubmit}>
				...
				<Grid container flexDirection="column" gap={30}>
					<Grid container flexDirection="column" gap={7}>
						...
						<TextForgotPassword onClick={handleForgotPassword}>Lupa password?</TextForgotPassword>
					</Grid>

					<LabeledInput name="newPassword" title="Password baru" />
					<LabeledInput name="confirmNewPassword" title="Konfirmasi password baru" />
					<ButtonWrapper>
						<StyledButton style={{ fontWeight: fontWeights.bold, padding: "5px " }}>
							Ubah Password
						</StyledButton>
					</ButtonWrapper>
				</Grid>
