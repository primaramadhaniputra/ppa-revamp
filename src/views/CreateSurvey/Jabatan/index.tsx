    ...
    <>
      <Modal onClose={handleCloseModal} isShow={isOpenModal} title="Filter Jabatan">
        ...
        >
          ...
          <JabatanContainer >
            <Grid style={{ borderBottom: '1px solid #ddd', padding: '10px 10px 8px 8px' }} container justifyContent='space-between'>
              <Text variant="p" >Jabatan</Text>
              <Checkbox checked />
            </Grid>
            <Grid flexDirection='column' gap={12} container style={{ padding: '10px 10px 8px 8px' }} >
              <Input placeholder='Cari Jabatan Anda Disini' iconLeft='IcSearch' style={{ borderRadius: "4px" }} />
      ...
      <Grid>
        <Button onClick={handleOpenModal} variant="primary" style={{ backgroundColor: '#141bbe', borderRadius: "6px" }}>
