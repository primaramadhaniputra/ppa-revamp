...
export default function Sites({ sites }: IProps) {
   ...
   isShowChart ? disableBodyScroll(Html as unknown as HTMLElement | Element) : enableBodyScroll(Html as unknown as HTMLElement | Element)
   return (
      <>
         {
            isShowChart && <ChartWrapper style={{ top: `${formPosition}px` }}>
               <Chart>
