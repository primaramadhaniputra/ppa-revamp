...
export const defaultDataTable = arr.map(() => {
	return {
		["CN"]: "E52015",
		["Break Accumulator Oil Press (Front)"]: "127.2",
		["Break Accumulator Oil Press (Rear)"]: "127.2",
		["Status"]: "Warning",
	};
});
...
export default function BreakOil() {
	...
	const renderTdText = (type: string, info: IProps) => {
		if (type === "CN") {
			...
			return <TextTable>{info.renderValue()}</TextTable>;
		}
	};
	...
	return (
		<>
			...
			<WrapperTitle style={{ marginTop: "20px" }}>
				<TitleText> Break Oil Press</TitleText>
			</WrapperTitle>
