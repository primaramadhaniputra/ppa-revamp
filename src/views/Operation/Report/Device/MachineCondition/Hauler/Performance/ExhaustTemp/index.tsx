...
export const defaultDataTable = arr.map(() => {
	return {
		["CN"]: "E52015",
		["Ex TempMax LF(deg C)"]: "127.2",
		["Ex TempMax LR(deg C)"]: "127.2",
		["Ex TempMax RF(deg C)"]: "127.2",
		["Ex TempMax RR(deg C)"]: "127.2",
		["Status"]: "Warning",
	};
});
...
export default function ExhaustTemp() {
	...
	return (
		<>
			...
			<WrapperTitle style={{ marginTop: "20px" }}>
				<TitleText> Exhaust Temp</TitleText>
			</WrapperTitle>
